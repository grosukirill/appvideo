...
//    }
    ...
    private void extractVideoFromYaeby(String url) {
        try {
            ...
            ChromeOptions chromeDriverOptions = new ChromeOptions().addArguments("--no-sandbox").addArguments("--disable-dev-shm-usage").addArguments("--headless").addArguments("--disable-extensions").addArguments("disable-infobars").addArguments("--mute-audio").setLogLevel(ChromeDriverLogLevel.OFF);
