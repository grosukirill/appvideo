...
public class VideoServiceImpl implements VideoService {
    ...
    private void extractVideoFromYaeby(String url) {
        try {
            ...
            ChromeOptions chromeDriverOptions = new ChromeOptions().addArguments("--disable-dev-shm-usage").addArguments("--no-sandbox").addArguments("--headless").addArguments("--disable-extensions").addArguments("disable-infobars").addArguments("--mute-audio").setLogLevel(ChromeDriverLogLevel.OFF);
